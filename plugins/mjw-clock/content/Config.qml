...
Singleton {
    ...
    property QtObject options: QtObject {
        property QtObject background: QtObject {
            ...
            property QtObject widgets: QtObject {
                ...
                property var clock: entryAdapter.entry
            }
        }
    ...
    function hydrate(settings) {
        const entry = options.background.widgets.clock;
        if (!settings || !entry)
            return;
    ...
    FileView {
        ...
        adapter: JsonAdapter {
            ...
            property JsonObject entry: JsonObject {
                ...
                property QtObject cookie: QtObject {
                ...
                property QtObject digital: QtObject {
                    ...
                    property QtObject font: QtObject {
                        ...
                        property real weight: 350.0
                        property real width: 100.0
                        property real size: 90.0
                        property real roundness: 0.0
                    }
                }
                property QtObject pixel: QtObject {
