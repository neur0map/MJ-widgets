                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    onClicked: Quickshell.execDetached(["ryoku-shell", "lock"])
                                }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    anchors.fill: parent
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: Quickshell.execDetached(["ryoku-shell", "hub", "open"])
                                }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea {
                                    anchors.fill: parent
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: Quickshell.execDetached(["ryoku-shell", "menu", "quick-settings"])
                                }
                            }
                        }
                    }
