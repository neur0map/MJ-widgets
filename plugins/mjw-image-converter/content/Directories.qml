...
Singleton {
    ...
    readonly property string pluginState: state + "/ryoku/plugins/mjw-image-converter"
    readonly property string pluginCache: cache + "/ryoku/plugins/mjw-image-converter"
