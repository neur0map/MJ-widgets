...
Month calendar tile with today highlighted, month navigation, and three size presets.
...
- Writes: the plugin's own state under
  `$XDG_STATE_HOME/ryoku/plugins/mjw-calendar` (style choices and widget data only).
