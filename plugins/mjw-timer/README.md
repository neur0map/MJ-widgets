...
Pomodoro, stopwatch and countdown with ring progress, desktop notifications and an alert sound.
...
- Reads: system clock; /usr/share/sounds themes
- Network: none
- Writes: the plugin's own state under
  `$XDG_STATE_HOME/ryoku/plugins/mjw-timer` (style choices and widget data only).
